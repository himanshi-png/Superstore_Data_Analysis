...
This project, I analysed the areas where there are least sales of a Superstore In this project, I  used libraries like panda, matplotlib and seaborn to explore which region has least sales,
